    ...
    return (
        <div className={"w-screen h-screen flex items-center justify-center"}>
            <div className={"border border-black rounded w-6/12 bg-white p-5"}>
                ...
                {
                    cameFromCreateAccount ? <div className={"text-green-700 mb-3"}>Your account has been created! Please login below to continue</div> : <></>
                }
                <div>
                    <label htmlFor="email"
                ...
                <div className={"flex flex-col mt-3"}>
                    <button type="button"
                            onClick={login}
                            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Login</button>
                    <button type="button"
                            onClick={() => window.open("/account/create", "_self")}
                            className="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Create Account</button>
                </div>
            </div>
        </div>
    );
